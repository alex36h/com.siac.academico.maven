...
public class JIAdminRolUpdate extends javax.swing.JInternalFrame {
    ...
    public JIAdminRolUpdate(String credencial) {
        initComponents();
        Init(credencial);
    }
    ...
    {
        x = new JPACrud();
        objCredencial = x.getCred(obj);
        this.JTNombreCompleto.setText(objCredencial.getPersona().getNombreCompleto().toUpperCase());
        this.JTUsuario.setText(objCredencial.getCredencialPK().getUsuario().toUpperCase());
        this.JTRol.setText(objCredencial.getGrupo().getNombre());
        fillComboBox();
    }
    ...
    private void initComponents() {
        ...
        JbuttonUpdate.setBackground(new java.awt.Color(2, 136, 209));
        JbuttonUpdate.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        JbuttonUpdate.setForeground(new java.awt.Color(255, 255, 255));
        JbuttonUpdate.setText("Actualizar clave");
        ...
        JTNombreCompleto.setEditable(false);
        JTNombreCompleto.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N

        JTRol.setEditable(false);
        JTRol.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(JTConfirmar, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                            .addComponent(JTRol)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void UpdatePass()
    {
        try {
            ...
            {
                 x = new JPACrud();
                 if(x.updatePassword(this.JTClave.getText(), objCredencial.getCredencialPK().getUsuario()))
