...
import com.siac.entities.Tipobeca;
import com.siac.services.JPACrud;
import static com.siac.services.Util.UPDATE_OK;
import javax.swing.JOptionPane;

public class JDTipoBEca extends javax.swing.JDialog {

    JPACrud x;
    int Id;
    Tipobeca obj;
    
    public JDTipoBEca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public JDTipoBEca(java.awt.Frame parent, boolean modal,Tipobeca tb) {
        super(parent, modal);
        initComponents();
        init(tb);
    }
    ...
    private void JBUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBUpdateActionPerformed
            ...
            JOptionPane.showMessageDialog(rootPane, "Debe Ingresar un tipo de beca");
            txtNombre.requestFocus();
            return;
        } else if (txtDescrip.getText().equals("")) {
         JOptionPane.showMessageDialog(rootPane, "Debe Ingresar la descripcion de un tipo de beca");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDTipoBEca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDTipoBEca dialog = new JDTipoBEca(new javax.swing.JFrame(), true);
