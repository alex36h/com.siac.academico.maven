...
public class JIBanco extends javax.swing.JInternalFrame {
    ...
    private void Save() {
        try {
            ...
            banco.setNombre(this.txtNombre.getText());
            banco.setDescripcion(this.txtDescrip.getText());
    ...
    private void Refrescar() {
        try {
            ...
            List<Banco> entidad = x.buscarTodo(Banco.class);
    ...
    private void Update() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            JDBanco dialog = new JDBanco(f, true, obj);
