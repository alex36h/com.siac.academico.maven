...
public class JITipoBeca extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            JOptionPane.showMessageDialog(rootPane, "Debe Ingresar el Tipo de Beca");
    ...
    private void Save() {
        try {
            ...
            tb.setNombre(this.txtNombre.getText());
            tb.setDescripcion(this.txtDescrip.getText());
            tb.setActivo(true);
            x.save(tb);
    ...
    private void Refrescar() {
        try {
            x = new JPACrud();
            model = getModel(COL_MONEDA, false);
            limpiarJTable(model);

            List<Tipobeca> entidad = x.buscarTodo(Tipobeca.class);
    ...
    private void Update() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            JDTipoBEca dialog = new JDTipoBEca(f, true, obj);
